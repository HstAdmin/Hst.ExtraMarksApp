...
namespace Hst.ExtraMarksApp.Services
{
    public class ApiAuthorizer
    {
        ...
        //    stringBuilder.AppendFormat("?client_id={0}", System.Net.WebUtility.UrlEncode(_clientId));
        //    stringBuilder.AppendFormat("&redirect_uri={0}", System.Net.WebUtility.UrlEncode(redirectUrl));
        ...
        //        stringBuilder.AppendFormat("&scope={0}", System.Net.WebUtility.UrlEncode(scopeJoined));
        //    }
