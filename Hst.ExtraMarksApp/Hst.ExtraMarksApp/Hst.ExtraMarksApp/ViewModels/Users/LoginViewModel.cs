...
using Hst.ExtraMarksApp.Common;
...
namespace Hst.ExtraMarksApp.ViewModels.User
{
    public class LoginViewModel : BaseViewModel
    {
        ...
        public async void OnClickLogin()
        {
            ...
            {
                if (response.Data.UserTypeId == (int)UserTypes.Admin || response.Data.UserTypeId == (int)UserTypes.BookSeller || response.Data.UserTypeId == (int)UserTypes.Parents)
                {
